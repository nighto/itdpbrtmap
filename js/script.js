            ...
            study[brts[b]][categories[c]][levels[l]].geojson = L.geoJson(window[brts[b] + '_' + categories[c] + '_' + levels[l]], {
              onEachFeature: function(feature, layer){
                ...
                if(feature.properties.VoteCode){
                  popupText += '<br><br><strong>Qual a prioridade para você?</strong> <a href="javascript:vote(\'' + feature.properties.VoteCode + '\', 1)"><span class="glyphicon glyphicon-star star-1"></span></a><a href="javascript:vote(\'' + feature.properties.VoteCode + '\', 2)"><span class="glyphicon glyphicon-star star-2"></span></a><a href="javascript:vote(\'' + feature.properties.VoteCode + '\', 3)"><span class="glyphicon glyphicon-star star-3"></span></a><a href="javascript:vote(\'' + feature.properties.VoteCode + '\', 4)"><span class="glyphicon glyphicon-star star-4"></span></a><a href="javascript:vote(\'' + feature.properties.VoteCode + '\', 5)"><span class="glyphicon glyphicon-star star-5"></span></a><span id="' + feature.properties.VoteCode + '_votemsg" style="display:none;">Voto computado com sucesso.</span><br><p style="position: relative; top: -10px; bootom: -10px; font-size: 90%; font-style: italic;">O ITDP Brasil quer saber a sua opinião!<br> Você pode votar sobre a prioridade deste ponto em uma escala de 1 (baixa prioridade, à esquerda) a 5 (alta prioridade, à direita).</p>';
                }
